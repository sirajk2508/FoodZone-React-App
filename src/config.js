export const restaurantList1 = [
  ...
  export const restaurantList = [
    ...
    },
    {
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/pizza-hut-collage-road-college-road-nashik-236456",
        "type": "WEBLINK"
      }
    },
    {
    ...
    },
    {
      "info": {
        "id": "69634",
        "name": "Domino's Pizza",
        "cloudinaryImageId": "tbtiv1p6nvos7ldqttrg",
        "locality": "Near Purnima Bus Depot",
        "areaName": "General Vaidya Nagar",
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/dominos-pizza-near-purnima-bus-depot-general-vaidya-nagar-nashik-69634",
        "type": "WEBLINK"
      }
    },
    {
    ...
    },
    {
      "info": {
        ...
        "cloudinaryImageId": "qqslc6q6cklmllyxyh44",
        "locality": "Police C Office Road",
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/kwality-walls-frozen-dessert-and-ice-cream-shop-police-c-office-road-canada-corner-nashik-531582",
        "type": "WEBLINK"
      }
    },
  ];
...
export const CareersSection = () => {
  const careersDescription = `
    Welcome to Instamart Careers! We're seeking passionate individuals to join our innovative team. Whether you're a Software Engineer, Delivery Specialist, Customer Support Representative, or Marketing Specialist, exciting opportunities await!
    ...
    How to Apply: Send your resume and cover letter to careers@instamart.com. Specify the position in the subject line.

    We look forward to reviewing your application and potentially welcoming you to Team Instamart!

    &copy; 2024 Instamart. All rights reserved.
  `;
  return careersDescription;
}

export const AboutSection = () => {
  const aboutDescription = "Instamart is a rapid grocery and Kirana items delivery service provided by Swiggy, catering to the growing demand for quick and convenient access to daily essentials. Operating from 7 am until late at night every day, Instamart promises to deliver orders within an impressive timeframe of 15-20 minutes from the time of ordering. Key features of Instamart include its focus on groceries and Kirana items, indicating a comprehensive range of products to meet customers' daily needs. The service's affiliation with Swiggy suggests a well-established platform leveraging Swiggy's existing infrastructure and delivery network. Customers using Instamart can benefit from the convenience of swift delivery, allowing them to access essential items promptly without the need for extensive planning or waiting times. The service is positioned to streamline the grocery shopping experience, making it a viable option for those seeking quick and efficient solutions. To enhance user experience, Instamart may offer a user-friendly app or website interface, allowing customers to browse through a diverse catalog of products, place orders seamlessly, and track their deliveries in real-time. The promise of a short delivery window sets Instamart apart in the competitive online grocery delivery space, appealing to individuals with busy lifestyles or those in need of immediate supplies."
  return aboutDescription
}

export const TeamSection = () => {
  const teamDescription = "Welcome to Team Instamart! We are a passionate group of professionals dedicated to revolutionizing the way people access essential goods. Our diverse team, including tech enthusiasts, logistics experts, customer support heroes, and creative minds, collaboratively works to make grocery and Kirana item deliveries faster and more convenient. At Team Instamart, our mission is to provide a seamless and enjoyable shopping experience. From our tech developers crafting cutting-edge technology to the delivery squad ensuring your items reach you within 15-20 minutes, each member plays a crucial role in our success. Join us on this exciting journey as we grow, innovate, and redefine the standards of quick and efficient grocery delivery services. Your satisfaction is our priority!";
