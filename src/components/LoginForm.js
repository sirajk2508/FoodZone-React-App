  ...
  return (
    <div className="flex flex-col items-center justify-center my-28">
      ...
      <div className="flex mb-4 text-center">
        <img
          className="w-24 h-20 rounded-xl shadow-2xl hover:w-[98px] hover:h-[82px] mx-4"
          alt="Food Zone Logo"
        ...
        ></img>
        <h2 className="text-2xl font-bold my-5">Login Page</h2>
      </div>

      <form className="w-full max-w-md" onSubmit={handleSubmit} name="form">
        <div className="mb-4">
          <label
            htmlFor="form"
          ...
          <input
            type="text"
            value={name}
            className="border border-gray-300 rounded-md w-full mt-1 p-1"
